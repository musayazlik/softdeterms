            ...
            <div className='grid grid-cols-1 sm:grid-cols-12 gap-6 px-8 md:px-20 xl:px-60 '>
              <div className='flex flex-col gap-2 col-span-10 col-start-2'>
                ...
                <input
                  ...
                  name='name'
                  id='name'
                  className='border-2 border-gray-300 rounded-md px-4 py-2 focus:outline-double focus:outline-4 focus:outline-offset-2 focus:outline-zinc-700 duration-300 focus:border-zinc-700'
                />
              </div>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-12 gap-6 px-8 md:px-20 xl:px-60 '>
