...
const Footer = () => {
  return (
    <>
      <footer className='bg-indigo-50 dark:bg-zinc-700/20 text-indigo-600 dark:text-zinc-50 shadow-md shadow-indigo-50/40 dark:shadow-slate-900/20 pt-8 lg:pt-4 text-center grid grid-cols-12 px-4 sm:px-12 relative z-20'>
        ...
        <div className=' col-span-12 my-8 sm:col-span-4 lg:col-span-3'>
          <Link
            href={'/'}
