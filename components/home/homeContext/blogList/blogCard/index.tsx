...
const BlogCard = ({ post }: any) => {
  ...
  return (
    <>
      <div className='flex flex-col sm:grid sm:grid-cols-12 px-4 py-6 gap-8 bg-zinc-50 dark:bg-zinc-800 rounded-lg border-2 border-zinc-300/40 dark:border-zinc-900/80 hover:bg-zinc-100 duration-300 hover:shadow-lg hover:shadow-zinc-200/50 dark:hover:shadow-zinc-900/50 hover:cursor-pointer hover:relative hover:border-in'>
        ...
        <Link
          ...
          <div className='postDetail mb-6 sm:mb-0 text-center sm:text-start'>
            <h3 className='text-lg sm:text-2xl mb-4 font-black text-zinc-900 dark:text-zinc-400 '>
              {post.title}
            </h3>
            <p className='text-sm sm:text-base text-zinc-700 dark:text-zinc-400 mb-5 font-medium'>
